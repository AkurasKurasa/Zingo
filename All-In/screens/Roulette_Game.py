...
FONT_PATH = os.path.join(ROOT_DIR, "fonts", "PixelifySans-Regular.ttf")
LOGO_PATH = os.path.join(ROOT_DIR, "All-In", "png_icons", "allin_roulette_center.png")
...
# --- LOAD KV STRING ---
Builder.load_string(KV)  # ← CRITICAL: LOAD BEFORE USING IDS
...
class MainUI(BoxLayout):
    ...
    def _post_init(self, dt):
        ...
        self.wheel_widget = self.ids.wheel
        self.wheel_widget.angle = 0
        self.wheel_widget._redraw()

    # ... [rest of methods: prepare_number_bet, place_color_bet, spin_wheel, etc.] ...
